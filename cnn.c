...
void log_softmax(float input[NUM_FILTERS_7], int input_size, float output[NUM_FILTERS_7])
{
...
{
    float layer1[NUM_FILTERS_1][OUTPUT_ROWS_1][OUTPUT_COLS_1]; // convolution (6*28*28)
    float layer2[NUM_FILTERS_2][OUTPUT_ROWS_2][OUTPUT_COLS_2]; // max_pooling (6*14*14)
    float layer3[NUM_FILTERS_3][OUTPUT_ROWS_3][OUTPUT_COLS_3]; // convolution (16*10*10)
    float layer4[NUM_FILTERS_4][OUTPUT_ROWS_4][OUTPUT_COLS_4]; // max_pooling (16*5*5)
